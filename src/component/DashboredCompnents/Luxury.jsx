...
const LuxuryDashboard = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axiosInstance.post('https://sleepy-blinnie-beshoynasry-2859766e.koyeb.app/api/laxury', formData, {
  ...
  return (
    <div className="flex min-h-screen bg-[#111612] text-white">
      ...
      <div className="flex-1 p-6">
        <h1 className="text-2xl font-semibold mb-6 text-center">luxry </h1>
